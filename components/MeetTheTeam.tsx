...
const TEAM = [
  {
    ...
    bio: "Explains Bitcoin the way a smart friend does. Never hypes. Never talks down.",
    image: "/avatars/uncle-ray.svg"
  },
  {
    name: "Grandma June",
    role: "The Memory Keeper",
    bio: "Been through every crash. Puts today's news in perspective.",
    image: "/avatars/grandma-june.svg"
  },
  {
    name: "Cousin Marco",
    role: "Global Scout",
    bio: "Finds the Bitcoin stories happening in the real world, not just on charts.",
    image: "/avatars/cousin-marco.svg"
  },
  {
    name: "Auntie Claire",
    role: "The Patient Explainer",
    bio: "Breaks down every concept until it actually clicks. No jargon. Ever.",
    image: "/avatars/auntie-claire.svg"
  },
  {
    name: "Big Brother Dan",
    role: "The Honest Reviewer",
    bio: "Tests the tools you might actually use. No agenda. Just the truth.",
    image: "/avatars/big-brother-dan.svg"
  },
  {
    name: "Little Sister Sofia",
    role: "Your Reality Check",
    bio: "If she'd close the tab, it doesn't publish. She's you.",
        ...
        <div className="mb-6 sm:mb-10 md:mb-14 lg:mb-20">
            <div className="mb-3 sm:mb-4 md:mb-5 lg:mb-6">
                ...
                <p className="text-xs xs:text-sm sm:text-base md:text-lg font-serif text-slate-700 leading-relaxed max-w-2xl">
                    Meet the agentic team that breaks down the Bitcoin world for you. No jargon, no hype—just honest explanations from people who actually understand the space.
                </p>
